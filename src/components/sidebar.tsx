...
const navElements = [
  ...
  {
    title: "Operasi Barang",
    href: "/tambahbarang",
    icon: <AiOutlineDropbox className="w-6 h-6 mr-2" />,
  },
  {
    title: "Laporan",
    href: "/Laporan",
    icon: <AiOutlineAudit className="w-6 h-6 mr-2" />,
  },
  {
    title: "Profil",
    href: "/profile",
...
export const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-0 bottom-0 h-screen bg-gray-900 text-gray-100 flex flex-col ${isCollapsed ? "w-20" : "w-64"} transition-all duration-300`}
    >
      <div className="flex items-center justify-between h-20 bg-gray-900 border-b border-gray-700 p-4">
        {!isCollapsed && (
